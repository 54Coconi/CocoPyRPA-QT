...
class Ui_MainWindow(object):
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.action_menu_KeyStroke.setStatusTip(_translate("MainWindow", "模拟键盘【单个按钮】按下和释放（如“enter”、“a”、“F11”等）"))
        ...
        self.action_menu_EntTxtOnKeyboard.setStatusTip(_translate("MainWindow", "根据txt文本内容【不支持中文内容】依次执行<按键>操作，即模拟连续的按键"))
